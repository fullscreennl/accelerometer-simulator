...
ControllerViewController *_controller;
...
- (void)accelerationChanged:(UISlider*)control {
    ...
    AccelerationInfo *accelInfo = [AccelerationInfo createWithTimestamp:CFAbsoluteTimeGetCurrent() X:x Y:y Z:z BTN:[_controller getBtnStatus]];
...
- (void)accelerometer:(UIAccelerometer *)accelerometer didAccelerate:(UIAcceleration *)acceleration {
	...
	// create information message
    AccelerationInfo *accelInfo = [AccelerationInfo createWithTimestamp:timeStamp X:x Y:y Z:z BTN:[_controller getBtnStatus]];
