...
- (void)applicationDidFinishLaunching:(UIApplication *)application {
    ...
    controllerView = [[ControllerViewController alloc] initWithNibName:@"ControllerViewController" bundle:nil];
    [[[[tabBarController viewControllers] objectAtIndex:2] view] addSubview:[controllerView view]];
    [accelerometerViewController setController:controllerView];
