...
- (void)accelerationUpdate:(NSNotification*)notification {
	...
	if( networkEnabled && udpSocket != -1 )
	{
		...
		const char *msg = [[NSString stringWithFormat:@"ACC: %s,%.3f,%1.3f,%1.3f,%1.3f,%i\n",[info.deviceID UTF8String],info.absTime,info.x,info.y,info.z, info.btnPressed ] UTF8String];
